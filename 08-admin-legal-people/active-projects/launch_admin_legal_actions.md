# Launch Admin / Legal / People Actions

Owner: Admin / Legal / People
...
LLC → EIN → business bank account → Stripe / Shopify Payments

This can slow launch, so it should start early.

Track B can happen separately:
